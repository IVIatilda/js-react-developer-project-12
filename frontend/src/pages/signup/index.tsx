...
export const SignupPage = () => {
  ...
  const SignupSchema = Yup.object().shape({
    ...
    password: Yup.string().trim().min(6, t('errors.password')).required(t('errors.required')),
        ...
        <div className="card shadow-sm">
          <div className="card-body row p-5">
            <div className="col-12 col-md-6 d-flex align-items-center justify-content-center">
              <img src={loginImg} alt="Logo" className="rounded-circle" />
            </div>
              ...
              <FloatingLabel label={t('placeholders.username')} className="mb-3" controlId="usernameField">
                ...
                <Form.Control.Feedback type="invalid" tooltip>
                  {formik.errors.username && formik.touched.username ? (
                    <div>{formik.errors.username.toString()}</div>
                  ) : null}
              ...
              <FloatingLabel label={t('placeholders.password')} className="mb-4" controlId="passwordField">
                ...
                <Form.Control.Feedback type="invalid" tooltip>
                  {formik.errors.password && formik.touched.password ? (
                    <div>{formik.errors.password.toString()}</div>
                  ) : null}
                </Form.Control.Feedback>
              </FloatingLabel>
              <FloatingLabel label={t('placeholders.repeatPassword')} className="mb-4" controlId="repeatPasswordField">
                ...
                <Form.Control.Feedback type="invalid" tooltip>
                  {formik.errors.repeatPassword && formik.touched.repeatPassword ? (
                    <div>{formik.errors.repeatPassword.toString()}</div>
                  ) : null}
                </Form.Control.Feedback>
              </FloatingLabel>
              <div className="d-grid gap-2">
                <Button variant="w-100 mb-3 btn btn-outline-primary" type="submit">
                  {t('buttons.register')}
                </Button>
              </div>
            </Form>
